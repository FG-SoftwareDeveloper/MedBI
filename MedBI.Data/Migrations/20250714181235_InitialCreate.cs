        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IconCssClass = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Claims_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "DoctorId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExerciseLevel = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Diet = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PatientId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientLifestyles", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "IconCssClass", "Order", "PageUrl", "Title" },
                values: new object[,]
                {
                    { 1, "bi bi-speedometer2", 1, "/Admin/Dashboard", "Dashboard" },
                    { 2, "bi bi-people", 2, "/Admin/ManageUsers", "Manage Users" }
                });

            migrationBuilder.InsertData(
                table: "NavigationItemRoles",
                columns: new[] { "Id", "NavigationItemId", "RoleName" },
                values: new object[,]
                {
                    { 1, 1, "Admin" },
                    { 2, 2, "Customer" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PatientLabResults_PatientId",
                table: "PatientLabResults",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientLifestyles_PatientId",
